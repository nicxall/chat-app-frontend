                    ...
                    <div className="flex items-center justify-center w-full lg:p-12">
                        <div className="flex items-center xl:p-10">
                            <form className="flex flex-col w-full h-full pb-6 text-center bg-gray-900 rounded-3xl" onSubmit={handleSubmit}>
                                <h3 className="mb-3 text-4xl font-extrabold text-white">Sign up</h3>
                                <p className="mb-4 text-gray-400">Enter your emaill and password</p>
                                <a
                                ...
                                />
                                <label htmlFor="email" className="mb-2 text-sm text-start text-gray-400">
                                    Email (opcional)
                                </label>
                                <input
                                    id="email"
                                ...
                                <p className="text-sm leading-relaxed text-gray-400">
                                    Not registered yet?
                                    <NavLink to='/' className="font-bold text-gray-300">
                                        Iniciar sesion
                                    </NavLink>
                                </p>
                            </form>
